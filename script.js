        ...
        ">
          ...
          <div style="display:flex;gap:6px;">
            ...
            <button onclick="decreaseQty(${index})"
              style="background:#999;padding:5px 10px;border-radius:6px;">
              −
            </button>

            <button onclick="increaseQty(${index})"
              style="background:#16a34a;padding:5px 10px;border-radius:6px;">
              +
            </button>

            <button onclick="removeItem(${index})"
              style="background:#dc2626;padding:5px 10px;border-radius:6px;">
              ✕
            </button>
